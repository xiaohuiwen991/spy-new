...
public class Cn2PyUtil {
	
	// 简体中文的编码范围从B0A1（45217）一直到F7FE（63486）
		private static int CN_BEGIN = 45217;
		private static int CN_END = 63486;
		...
		public static String cn2py(String SourceStr) {
			if("重庆".equals(SourceStr)) return "cq";
			String Result = "";
		...
		private static char Char2Initial(char ch) {
			...
			if ((gb < CN_BEGIN) || (gb > CN_END))// 在码表区间之前，直接返回
			{
				return ch;
			}
			int i;
